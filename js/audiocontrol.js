...
HTMLAudioElement.prototype.setCurrentSrc = function(currentSrcIndex){
	...
	$("#containerbody").css("background-image","url(\"http://7xrr54.com1.z0.glb.clouddn.com/bg"+val+".jpg\")+" );
	$(".mask_bg").css("background-image","url(\"http://7xrr54.com1.z0.glb.clouddn.com/bg"+val+".jpg\")+" );
